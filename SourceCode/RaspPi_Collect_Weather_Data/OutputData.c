...
int stcOutputData_Parse(char *inputString, stcOutputData_t **stcOutputDataStructure)
{
    ...
    if ((inputString != NULL) && (strlen(inputString) == 34)) // If input string contain carriage return and new line character, the lengeth will be 35. Otherwise, it will be 33
    {
